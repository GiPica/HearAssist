    ...
    <div className="flex flex-col min-h-screen px-5">
      <div className="flex items-center gap-3 pt-5 pb-4">
        ...
        <h1 className="text-2xl font-extrabold leading-tight">
          <span className="text-[#1B2A6B]">CONVERS</span><span className="text-[#7B5EA7]">ATIONAL</span>
          <br />
          <span className="text-[#1B2A6B]">MODE</span>
        </h1>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-8">
        <GlassCard className="w-full flex flex-col items-center py-10 gap-8">
          ...
          <button
            onClick={() => navigate('/active-session?mode=conversation')}
